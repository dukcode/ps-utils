...
/**
 * 단일 문제 풀이 테스트 케이스를 실행함.
 *
 * <p>이 실행자는 @PSTestCases에서 정의된 각 테스트 케이스에 대해
 * I/O 리다이렉션, 타임아웃 검증, 출력 검증을 처리함.
 */
public class PSTestCaseExecutor implements BeforeEachCallback, AfterEachCallback,
    InvocationInterceptor {

  // 다른 Extension과의 충돌을 피하기 위한 네임스페이스
  private static final Namespace NAMESPACE = Namespace.create(PSTestCaseExecutor.class);
   ...
   */
  public PSTestCaseExecutor(PSTest psTest, PSTestCase testCase) {
    this.psTest = psTest;
